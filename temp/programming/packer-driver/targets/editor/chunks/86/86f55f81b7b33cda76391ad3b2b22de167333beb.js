  ...
  return {
    ...
    execute: function () {
      ...
      _export("MatrixManager", MatrixManager = (_dec = ccclass('MatrixManager'), _dec(_class = class MatrixManager extends Component {
        ...
        isEmpty(indexRow) {
          for (let i = 0; i < this.matrixData[indexRow].length; i++) if (this.matrixData[indexRow][i] === 1) return false;

          return true;
        }

        getListRowFull() {
          let listRow = new Array();

          for (let i = 0; i < this.matrixData.length; i++) if (this.isFull(i)) {
        ...
        isFull(indexRow) {
          ...
          for (let i = 0; i < this.matrixData[indexRow].length; i++) if (row[i] !== 1) return false;
...
//# sourceMappingURL=86f55f81b7b33cda76391ad3b2b22de167333beb.js.map