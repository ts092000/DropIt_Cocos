    ...
    execute: function () {
      ...
      _export("Block", Block = (_dec = ccclass('Block'), _dec2 = property(Sprite), _dec(_class = (_class2 = class Block extends Component {
        ...
        setIndex(row, col, time) {
          ...
          this.indexCol = col;
          if (!time) time = 0.15;
          let position = new Vec3(this.indexCol * (_crd && Contants === void 0 ? (_reportPossibleCrUseOfContants({
            error: Error()
...
//# sourceMappingURL=27f9cceac3e33f3f79205f0a252719f382e34776.js.map