  ...
  return {
    ...
    execute: function () {
      ...
      _export("PoolManager", PoolManager = (_dec = ccclass('PoolManager'), _dec2 = property({
        ...
        initPoolBlock() {
          for (var i = 0; i < 20; i++) {
            var element = instantiate(this.prefabBlock);
            this.poolBlock.put(element);
          }
        }

        getBlock() {
          var element = this.poolBlock.size() > 0 ? this.poolBlock.get() : instantiate(this.prefabBlock);
          return element;
        }
...
//# sourceMappingURL=c9aa69bfdbf21a8fb38feebd1810c5b3820bdc64.js.map